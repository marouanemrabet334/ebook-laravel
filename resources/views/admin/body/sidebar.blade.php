              ...
              <ul class="metismenu" id="side-menu">
                  ...
                  <li>
                      ...
                      <ul class="nav-second-level" aria-expanded="false">
                          ...
                          <li><a href="{{ route('admin.subcategory.index') }}">All SubCategory</a></li>
                  ...
                  <li>
                      ...
                      <ul class="nav-second-level" aria-expanded="false">
                          <li><a href="{{ route('admin.author.index') }}">All Author</a></li>
                  ...
                  <li>
                      ...
                      <ul class="nav-second-level" aria-expanded="false">
                          <li><a href="{{ route('admin.ebook.index') }}">All Ebook</a></li>
                          <li><a href="{{ route('admin.ebook.create') }}">Add Ebook</a></li>
