    ...
    <div class="row">
                                    ...
                                    <select name="subcategory_id" class="form-control" required="">
                                        ...
                                        @foreach ($subcategory as $sub)
                                            <option value="{{ $sub->id }}"
                                                ...
                                                {{ $sub->subcategory_name_ar }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <textarea name="short_descp_ar" id="textarea" class="form-control" placeholder="Textarea text"
                                        style="height: 390px;"> {!! $books->short_descp_ar !!}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    {{-- <textarea name="long_descp_ar" id="my_summernote" style="height: 300px;"
                                    class="form-control" rows="4">
                                    {!! $books->long_descp_ar !!}
                                </textarea> --}}

                                <textarea id="summernote" name="long_descp_ar" style="height: 300px;" >
                                    {!! $books->long_descp_ar !!}
                                </textarea>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="card-box">
                    <form method="post" action="{{ route('update.ebook.thambnail') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <form method="post" action="{{ route('update.ebook.file') }}"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('ebook.multifile.delete', $file->id) }}"
